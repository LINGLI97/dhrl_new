...
class Algo(BaseAlgo):
    ...
    def collect_experience(self, random_goal= False, act_randomly=False, train_agent=True, graph=False):
        ...
        collision_rate = episode_collision_steps / self.env_params['max_timesteps']
        ...
        self.monitor.store(Train_CollisionRate=collision_rate)
        self.monitor.store(Train_CollisionSteps=episode_collision_steps)
