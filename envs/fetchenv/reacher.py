...
class Reacher3DEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    ...
    def _is_colliding(self):
        """Check if any unexpected contact (self-collision or environment) exists."""
    ...
    def step(self, a):
        ...
        return ob, reward_ctrl - float(fail), self.num_timesteps >= 100, dict(is_success=not fail, collision=collision)
