...
class MazeEnv(gym.Env):
  ...
  def _is_colliding_with_wall(self):
    """Check if the ant is in contact with any wall (block) geom."""
    ...
    for i in range(sim.data.ncon):
      ...
      if (geom1_name and geom1_name.startswith('block_')) or \
         (geom2_name and geom2_name.startswith('block_')):
        return True
    return False
  ...
  def step(self, action):
    ...
    info['collision'] = self._is_colliding_with_wall()
